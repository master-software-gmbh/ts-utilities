...
import { type Children, LinkDocumentation } from '../../model/link/documentation.ts';
import type { XmlElement } from '../../model/xml/element.ts';
import { BaseFactory } from '../base.ts';

export class LinkDocumentationFactory extends BaseFactory<LinkDocumentation, Children, object> {
  ...
  override async map(element: XmlElement, context: XmlMapperContext) {
    ...
    return success(new LinkDocumentation(element, result.data.children));
  }
}
