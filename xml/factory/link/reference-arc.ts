...
import { type Attributes, type Children, LinkReferenceArc } from '../../model/link/reference-arc.ts';
import type { XmlElement } from '../../model/xml/element.ts';
import { BaseFactory } from '../base.ts';

export class LinkReferenceArcFactory extends BaseFactory<LinkReferenceArc, Children, Attributes> {
  ...
  override async map(element: XmlElement, context: XmlMapperContext) {
    ...
    return success(new LinkReferenceArc(element, result.data.children, result.data.attributes));
  }
}
